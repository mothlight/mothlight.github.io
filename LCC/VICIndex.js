...
var map = L.map('map', {
  center: [-37.75345784512068, 144.93505494806166],
  zoom: 10,
  scrollWheelZoom: true
});
...
$.getJSON("./data/VICIndex_data.geojson", function (data) {
...
info.update = function (props) {
  ...
  this._div.innerHTML = (props ?
    '<div class="areaName">' + props.SA2_NAME21 + '</div>' : '<div class="areaName faded"><small>Hover over areas<br>Click tabs or arrow keys</small></div>') + '<div class="areaLabel"><div class="areaValue">Index</div>' +(props ? '' + (checkNull(props["" + year])) : '--') + '</div>';
};
info.addTo(map);
